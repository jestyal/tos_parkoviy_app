...
class CatalogOrganizationsList extends StatefulWidget {
  ...
  @override
  _CatalogOrganizationsListState createState() => _CatalogOrganizationsListState();
}
                  ...
                  itemBuilder: (_, index) {
                    return
                      items[index].name!.toLowerCase().contains(searchString)
                          || items[index].type!.toLowerCase().contains(searchString)
                          || items[index].shortDescr!.toLowerCase().contains(searchString)
                      ?
                      GestureDetector(
                        child: Container(
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                           items[index].shortDescr.toString(),
